...
No canal onde você pegou o ID CHANNEL, só é necessário enviar o link ou titulo do video desejado, caso envie o titulo uma caixa de pesquisa irá se abrir para selecionar a melhor opção para a pesquisa:
